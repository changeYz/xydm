...
<!-- saved from url=(0044)https://m.efucms.com/rank/book_last.html -->
...
<a class="toback tobackbg-new" href="<?php echo U('index');?>"></a>
<!-- 漫画最近更新 -->
    ...
    <div class="list clearfix" id="html_box" style="min-height: 748px;">
        ...
        <a href="<?php echo U('Book/bookinfo');?>&bid=<?php echo ($vo["id"]); ?>" class="clearfix">
            ...
            <div class="body">
                ...
                <div class="col">更新至：第<?php echo ($vo["episodes"]); ?>章 <!-- 跟我有一腿的，是你 --></div>
            </div>
        </a>
