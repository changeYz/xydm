...
<html data-dpr="1" style="font-size: 41.6px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title><?php echo ($_CFG['site']['name']); ?> - 分类</title>
...
<nav class="nav-row-cate mt-navbar">
    <div class="shrink collect-box condition-box" style="display: none;">
        <div class="row container close-type">
            ...
            <div class="item"><a href="javascript:;" type="tid" val="1" id="close-8">玄幻</a></div>
            <div class="item"><a href="javascript:;" type="tid" val="2" id="close-12">武侠</a></div>
            <div class="item"><a href="javascript:;" type="tid" val="3" id="close-1">都市</a></div>
            <div class="item"><a href="javascript:;" type="tid" val="4" id="close-11">网游</a></div>
        </div>
    </div>
    <div class="shrink open-box condition-box" style="display: block;">
        <div class="row has-label">
            ...
            <div class="container open-type">
                ...
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=2" type="tid" val="2" <?php if($cateid == 2): ?>class="active"<?php endif; ?> id="open-2">武侠</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=3" type="tid" val="3" <?php if($cateid == 3): ?>class="active"<?php endif; ?> id="open-3">都市</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=4" type="tid" val="4" <?php if($cateid == 4): ?>class="active"<?php endif; ?> id="open-4">网游</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=5" type="tid" val="5" <?php if($cateid == 5): ?>class="active"<?php endif; ?> id="open-5">军事</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=6" type="tid" val="6" <?php if($cateid == 6): ?>class="active"<?php endif; ?> id="open-6">科幻</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=7" type="tid" val="7" <?php if($cateid == 7): ?>class="active"<?php endif; ?> id="open-7">恐怖</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=8" type="tid" val="8" <?php if($cateid == 8): ?>class="active"<?php endif; ?> id="open-8">穿越</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=9" type="tid" val="9" <?php if($cateid == 9): ?>class="active"<?php endif; ?> id="open-9">总裁</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=10" type="tid" val="10" <?php if($cateid == 10): ?>class="active"<?php endif; ?> id="open-10">校园</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=11" type="tid" val="11" <?php if($cateid == 11): ?>class="active"<?php endif; ?> id="open-11">耿美</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=12" type="tid" val="12" <?php if($cateid == 12): ?>class="active"<?php endif; ?> id="open-12">爆笑</a></div>
                <div class="item"><a href="<?php echo ($selfurl); ?>&cateid=13" type="tid" val="13" <?php if($cateid == 13): ?>class="active"<?php endif; ?> id="open-13">同人</a></div>
            </div>
        </div>
        <div class="row has-label">
