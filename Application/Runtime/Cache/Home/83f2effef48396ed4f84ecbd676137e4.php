...
<!-- saved from url=(0044)https://m.efucms.com/rank/book_free.html -->
<html data-dpr="1" style="font-size: 16.64px;">
<head>
    ...
    <meta name="viewport"
          content="designWidth=750,width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    ...
    <script type="text/javascript" src="/Public/home/mhjs/fundebug.0.1.7.min.js"
            apikey="ba3a0e0d938e92b44f279067dffb8d071ee87fc35eb75918b7a900e8581a955d"></script>
    ...
    <script>(function () {
        new Image().src = '//res.efucms.com/wap_v3/images/placeholder-unruly.png?v=20171208';
    })();</script>
    <style>
...
<a class="toback tobackbg-free" href="<?php echo U('Book/index');?>"></a>
<!-- 免费漫画 -->
<div class="br-box free-box rank-view clearfix">
    ...
    <div class="list clearfix" id="html_box" style="min-height: 740px;">
        <!-- <div class="item clearfix"><a href="https://m.efucms.com/book/10094/" class="clearfix">
            <div class="cover"><img width="75" height="100" class=""
                                    href="/Public/home/mhimages/5a27984f0cef1.jpg"
                                    data-original="https://p.efucms.com/uploads/book/201712/5a27984f0cef1.jpg"
                                    style="background: rgb(238, 238, 238); display: block;"></div>
            <div class="body">
                <div class="title">丧尸纪元</div>
                <div class="col">
                    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <circle cx="12" cy="7" r="6" fill="#ccc"></circle>
                        <path d="M12 11a10 10 0 0 1 10 10 2 2 0 0 1-2 2H4a2 2 0 0 1-2-2 10 10 0 0 1 10-10z"
                              fill="#ccc"></path>
                    </svg>
                    周刀刀
                </div>
                <div class="col"><label class="tag">热血</label><label class="tag" style="margin-left:4px;">悬疑</label>
                </div>
                <div class="col">更新至：第39话 堵门</div>
            </div>
        </a></div> -->
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item clearfix">
        <a href="<?php echo U('Book/bookinfo');?>&bid=<?php echo ($vo["id"]); ?>" class="clearfix">
            <div class="cover">
            	<img width="75" height="100" class="" src="<?php echo ($vo["cover_pic"]); ?>" data-original="<?php echo ($vo["cover_pic"]); ?>" style="background: rgb(238, 238, 238); display: block;">
            </div>
            <div class="body">
                ...
                <div class="col">
                    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <circle cx="12" cy="7" r="6" fill="#ccc"></circle>
                        <path d="M12 11a10 10 0 0 1 10 10 2 2 0 0 1-2 2H4a2 2 0 0 1-2-2 10 10 0 0 1 10-10z" fill="#ccc"></path>
                    </svg>
                    	<?php echo ($vo["author"]); ?>
                </div>
                <div class="col">
                <?php echo ($vo["arr_catename"]); ?>
                </div>
                <div class="col">更新至：第<?php echo ($vo["episodes"]); ?>话 <!-- 跟我有一腿的，是你 --></div>
            </div>
        </a>
...
<script id="itemTpl" type="text/html">
    {{# for(var i = 0, len = d.length; i < len; i++){ var data = d[i]; }}
    <div class="item clearfix">
        <a href="/book/{{ data.book.id }}/" class="clearfix">
            <div class="cover">
                <img width="75" height="100" class="img-ajax-lazy"
                     src="//res.efucms.com/wap_v3/images/placeholder-unruly.png?v=20171208"
                     data-original="{{ data.book.book_unruly }}"/>
            </div>
            <div class="body">
                <div class="title">{{ data.book.book_name }}</div>
                <div class="col">
                    <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <circle cx="12" cy="7" r="6" fill="#ccc"/>
                        <path d="M12 11a10 10 0 0 1 10 10 2 2 0 0 1-2 2H4a2 2 0 0 1-2-2 10 10 0 0 1 10-10z"
                              fill="#ccc"/>
                    </svg>
                    {{ data.book.book_author }}
                </div>
                <div class="col">{{ showBookTags(data.book.book_tags)}}</div>
                <div class="col">{{ (data.book.end_state==1?'已完结：':'更新至：')+data.lastChapter.chapter_name }}</div>
            </div>
        </a>
    </div>
    {{# } }}
