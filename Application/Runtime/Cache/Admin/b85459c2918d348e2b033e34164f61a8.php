...
<div class="bodywrapper">
    ...
    <div class="centercontent">
            ...
            <h1 class="pagetitle">编辑听书</h1>
            <span class="pagedesc">请认真编辑听书的各项信息</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post" enctype="multipart/form-data">
				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						<th class="title">听书首页分类</th>
						<td>
							<?php if(is_array($_yook)): foreach($_yook as $k=>$v): if($v['show'] == 2): ?><input type="checkbox" name="bookcate[]" id="bookcate" value="<?php echo ($k); ?>"  <?php if(in_array($k, $bookcate)): ?>checked<?php endif; ?> /><?php echo ($v['name']); ?>&nbsp;&nbsp;&nbsp;<?php endif; endforeach; endif; ?>
						</td>
					</tr>
					<tr>
