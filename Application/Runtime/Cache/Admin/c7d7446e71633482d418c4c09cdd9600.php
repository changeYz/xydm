				...
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						...
						<td>
							...
							<input type="checkbox" name="arrcateids[]" id="arrcateids2" value="2"  <?php if(in_array(2, $arrcateids)): ?>checked<?php endif; ?> />武侠&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids3" value="3"  <?php if(in_array(3, $arrcateids)): ?>checked<?php endif; ?> />都市&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids4" value="4"  <?php if(in_array(4, $arrcateids)): ?>checked<?php endif; ?> />网游&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids5" value="5"  <?php if(in_array(5, $arrcateids)): ?>checked<?php endif; ?> />军事&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids6" value="6"  <?php if(in_array(6, $arrcateids)): ?>checked<?php endif; ?> />科幻&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids7" value="7"  <?php if(in_array(7, $arrcateids)): ?>checked<?php endif; ?> />恐怖&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids8" value="8"  <?php if(in_array(8, $arrcateids)): ?>checked<?php endif; ?> />穿越&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids9" value="9"  <?php if(in_array(9, $arrcateids)): ?>checked<?php endif; ?> />总裁&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids10" value="10"  <?php if(in_array(10, $arrcateids)): ?>checked<?php endif; ?> />校园&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids11" value="11"  <?php if(in_array(11, $arrcateids)): ?>checked<?php endif; ?> />耿美&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids12" value="12"  <?php if(in_array(12, $arrcateids)): ?>checked<?php endif; ?> />爆笑&nbsp;&nbsp;&nbsp;
							<input type="checkbox" name="arrcateids[]" id="arrcateids13" value="13"  <?php if(in_array(13, $arrcateids)): ?>checked<?php endif; ?> />同人&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr>
