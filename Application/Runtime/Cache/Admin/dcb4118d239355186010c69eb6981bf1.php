...
<div class="bodywrapper">
    ...
    <div class="centercontent">
            ...
            <h1 class="pagetitle">编辑听书分集（<?php echo ($book["title"]); ?>）</h1>
            <span class="pagedesc">请认真编辑听书分集的各项信息</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post" enctype="multipart/form-data">
				...
				<table class="form-table" cellspacing="1" border="0">
					<tr>
						<th class="title">分集标题<small>分集名称</small></th>
						<td>
							<input type="text" name="title" id="title" value="<?php echo ($info["title"]); ?>" class="smallinput" />
						</td>
					</tr>
					<tr>
						<th class="title">分集阅读金额<small>若该集需要付费，则采用</small></th>
						<td>
							<input type="text" name="money" id="money" value="<?php echo ($info["money"]); ?>" class="smallinput" />
						</td>
					</tr>
					<tr>
						<th class="title">第几话<small>集数编号</small></th>
						<td>
							<input type="text" name="ji_no" id="ji_no" value="<?php echo ($info["ji_no"]); ?>" class="smallinput" onkeyup="value=value.replace(/[^0-9]/g,'')" />
						</td>
					</tr>
					<tr>
						<th class="title">前一话编号<small>自己填的数字</small></th>
						<td>
							<input type="text" name="before" id="before" value="<?php echo ($info["before"]); ?>" class="smallinput" onkeyup="value=value.replace(/[^0-9]/g,'')" />
						</td>
					</tr>
					<tr>
						<th class="title">后一话编号<small>自己填的数字</small></th>
						<td>
							<input type="text" name="next" id="next" value="<?php echo ($info["next"]); ?>" class="smallinput" onkeyup="value=value.replace(/[^0-9]/g,'')" />
						</td>
					</tr>
					<tr>
						<th class="title">点赞数<small>仅供查看</small></th>
						<td>
							<input type="text" name="likes" id="likes" value="<?php echo ($info["likes"]); ?>" class="smallinput" onkeyup="value=value.replace(/[^0-9]/g,'')" />
						</td>
					</tr>
					<tr>
						<th class="title">听书内容</th>
						<td>
