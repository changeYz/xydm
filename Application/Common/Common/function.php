...
function get_mh_cate_name($status){
	...
	switch($status){
		...
		case 2: $status_str = '武侠'; break;
		case 3: $status_str = '都市'; break;
		case 4: $status_str = '网游'; break;
		case 5: $status_str = '军事'; break;
		case 6: $status_str = '科幻'; break;
		case 7: $status_str = '恐怖'; break;
		case 8: $status_str = '穿越'; break;
		case 9: $status_str = '总裁'; break;
		case 10: $status_str = '校园'; break;
		case 11: $status_str = '耿美'; break;
		case 12: $status_str = '爆笑'; break;
		case 13: $status_str = '同人'; break;
	}
	return $status_str;
}
